...
@InputType()
class ContractCreateNestedManyWithoutPropertiesInput {
...
export { ContractCreateNestedManyWithoutPropertiesInput as ContractCreateNestedManyWithoutPropertiesInput };
