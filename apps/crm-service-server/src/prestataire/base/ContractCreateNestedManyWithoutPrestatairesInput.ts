...
@InputType()
class ContractCreateNestedManyWithoutPrestatairesInput {
...
export { ContractCreateNestedManyWithoutPrestatairesInput as ContractCreateNestedManyWithoutPrestatairesInput };
